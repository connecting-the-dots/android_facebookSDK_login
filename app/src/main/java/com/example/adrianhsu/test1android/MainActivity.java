    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            PackageInfo info = getPackageManager().getPackageInfo(
                    "com.example.adrianhsu.test1android", PackageManager.GET_SIGNATURES);
        ...
        loginButton.setReadPermissions(Arrays.asList("public_profile, email, user_status, user_friends, user_about_me, user_location"));
